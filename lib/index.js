...
function getVersion(restoreToPointInTime) {
    ...
    function buildVersionListForUpdates(allObjectVersions) {
        ...
        buildVersionListForRowsCreatedBeforeGivenPointInTime(allObjectVersions)
            .then(function(versionList) { return buildVersionListForRowsCreatedAfterGivenPointInTime(versionList, allObjectVersions) })
